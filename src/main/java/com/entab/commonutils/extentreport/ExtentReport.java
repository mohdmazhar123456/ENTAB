package com.entab.commonutils.extentreport;


import com.entab.commonutils.applications.enums.ReportInfoMessageColorList;
...
public class ExtentReport extends Driver {
    ...
    public static void startTest(String testName, String methodName) {
        ...
        test.assignAuthor("ENTAB");
    }

    /**
     * Below Function is End the test case and using flush method it writes the
     * test logs.
     */
